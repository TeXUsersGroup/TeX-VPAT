...
\newcommand\vpattablehead{%
  \toprule
  \multicolumn{2}{l}{Criteria} & Conformance Level\\ %drop "Remarks and Explanations"
  \midrule}
...
\newcolumntype\vpatcols
   {p{\vpatnumcollen}
    p{\dimexpr\textwidth-\vpatconfcollen-\vpatnumcollen-6\tabcolsep}<{\RaggedRight}
    p{\vpatconfcollen}<{\RaggedRight}} 
   

\newcommand\vpattablesubhead[2]
  {\addlinespace
   \multicolumn{3}{l}{\textit{#1~#2}}   
   \\*}
