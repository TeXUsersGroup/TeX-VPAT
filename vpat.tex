...
\begin{tabular}{|c|c|c|}
	...
	\begin{itemize} 
		\item 9.1.1.1 (Web) \\
		\item 10.1.1.1 (Non-web development) \\
		\item 11.1.1.1.1 (Open Functionality Software) \\
		\item 11.1.1.1.2 (Closed Functionality Software) \\
		\item 11.8.2 (Authoring Tool)
		\item 12.1.2 (Product Docs)
		\item 12.2.4 (Support Docs)
	\end{itemize}
